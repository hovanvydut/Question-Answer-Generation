...
def run(args):
    ...
    model = QGModel(params, t5_model, t5_tokenizer)
    ...
    print ("Saving model...")
    save_path_model = '../../model/qg/'
    save_path_tokenizer = '../../tokenizer/qg/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('-dmn', '--dir_model_name', type=str, metavar='', default="qg", required=False, help='Directory model name.')
    ...
    parser.add_argument('-me','--max_epochs', type=int, default=6, metavar='', required=False, help='Number of max Epochs')

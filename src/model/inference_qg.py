...
def generate(args, device, qgmodel: QGModel, tokenizer: T5Tokenizer,  answer: str, context: str) -> str:
...
def run(args):
    ...
    checkpoint_model_path = args.checkpoint_model_path
    qgmodel = QGModel.load_from_checkpoint(checkpoint_model_path, hparams=params, t5model=t5_model, t5tokenizer=t5_tokenizer)
